...
const sf::Vector2f HEADER_POS = { WINDOW_WIDTH / 2 - 300, 10 };
...
{
	sf::Font newFont;
	newFont.loadFromFile("SundayMorning.ttf");
	this->m_font = newFont;
	...
	m_header.setString("Hello Fuckers !");
	...
	m_start.setPosition({ CENTER.x - 400, CENTER.y});
	...
	m_exit.setPosition({ CENTER.x + 200, CENTER.y});
